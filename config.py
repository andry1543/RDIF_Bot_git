...
rdif_api_url = 'http://report.rdif.ru/1C/ZUP_UK/vacation_calc.php?person_id='
xkcd_url = 'http://xkcd.ru/'
bash_url = 'http://bash.im/quote/'
...
/outofoffice - Сотрудники отсутствующие сегодня в офисе
...
zeroemplot = "Сегодня в отпуске никого нет"
zeroemplko = "Сегодня в командировке никого нет"
otpusk = "В отпуске:\nСотрудник  :  последний день отпуска\n"
komand = "В командировке:\nСотрудник  :  последний день командировки\n"
