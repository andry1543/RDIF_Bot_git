...
# Usage : python bot_service.py install
# Usage : python bot_service.py start
# Usage : python bot_service.py stop
# Usage : python bot_service.py remove
...
class AppServerSvc(win32serviceutil.ServiceFramework):
    _svc_name_ = "RDIF_bot"
    _svc_display_name_ = "RDIF bot"
    _svc_description_ = "RDIF bot for Telegram"
            ...
            def __non_threaded_polling(self, none_stop=False, interval=0, timeout=3, loop_timeout=0):
                ...
                while not self.__stop_polling.wait(interval):
                    if time.time() > time_out and loop_timeout != 0: break
                        .........
            '''
            main.bot.polling(none_stop=True, loop_timeout=30)
